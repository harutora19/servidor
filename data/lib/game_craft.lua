...
CRAFT.ITEMS[1]["E"] = {}
CRAFT.ITEMS[1]["E"][1] = {st = 1, qnt = 1, itemid = 2145, level = 0, timeByUnit = 5, exp = 0, recipe = {{2145,1}}, desc = "Um tecido muito delicado, usado para produção de decorações e acessórios fashion. (0 exp)"}
-- CRAFT.ITEMS[1]["E"][2] = {st = 2, qnt = 20, itemid = 2145, level = 2, timeByUnit = 5, exp = 2, recipe = {{2145,1}}, desc = "Este material é usado para acelerar o processo de construção de itens."}
-- CRAFT.ITEMS[1]["E"][3] = {st = 3, qnt = 1, itemid = 2145, unique = true, level = 0, timeByUnit = 300, exp = 5, recipe = {{12138,50},{2145,25}}, desc = "incentive sua equipe com esta bandeira de guerra e obtenha 5% de experiência extra!"}
...
CRAFT.ITEMS[1]["C"] = {}
-- CRAFT.ITEMS[1]["C"][1] = {st = 11, qnt = 1, itemid = 29838, level = 0, timeByUnit = 120, exp = 0, recipe = {{2145,1}}, desc = "Um tecido muito delicado, usado para produção de decorações e acessórios fashion. (0 exp)"}

CRAFT.ITEMS[1]["B"] = {}
-- CRAFT.ITEMS[1]["B"][1] = {st = 12, qnt = 1, itemid = 29838, level = 0, timeByUnit = 120, exp = 0, recipe = {{2145,1}}, desc = "Um tecido muito delicado, usado para produção de decorações e acessórios fashion. (0 exp)"}

CRAFT.ITEMS[1]["A"] = {}
-- CRAFT.ITEMS[1]["A"][1] = {st = 13, qnt = 1, itemid = 29838, level = 0, timeByUnit = 120, exp = 0, recipe = {{2145,1}}, desc = "Um tecido muito delicado, usado para produção de decorações e acessórios fashion. (0 exp)"}

CRAFT.ITEMS[1]["S"] = {}
-- CRAFT.ITEMS[1]["S"][1] = {st = 14, qnt = 1, itemid = 29838, level = 0, timeByUnit = 120, exp = 0, recipe = {{2145,1}}, desc = "Um tecido muito delicado, usado para produção de decorações e acessórios fashion. (0 exp)"}

CRAFT.ITEMS[2] = {} -- Profissão de id 2
CRAFT.ITEMS[2]["E"] = {}
CRAFT.ITEMS[2]["E"][1] = {st = 15, qnt = 1, itemid = 2145, level = 0, timeByUnit = 5, exp = 0, recipe = {{2145,1}}, desc = "Um tecido muito delicado, usado para produção de decorações e acessórios fashion. (0 exp)"}
