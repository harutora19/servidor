local number_string = {
  {number = 1000000000000000000000000, letter = "Sex"},
  {number = 1000000000000000, letter = "Qua"},
  {number = 1000000000000, letter = "Tri"},
  {number = 1000000000, letter = "Bil"},
  {number = 1000000, letter = "Mil"},
  {number = 1000, letter = "K"},
}
function convertToString(number)
  local retDmg = number
   for _, k in pairs(number_string) do
    if ((number / k.number) >= 1) then
       retDmg = string.format("%2.02f", (number / k.number)) .. k.letter
	   break
	  end
    end
  return retDmg
...
function getMonsterLootList(name)
	if name:find("Castform-") then return false end
	local monster = getMonsterInfo(name)
