...
function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg, 'pokemon') then
        selfSay("You can choose one among them: {Eevee}, {Porygon}, {Mr. Mime}, {Hitmonchan}, {Hitmonlee}, {Hitmontop} and {Riolu}  which would you choose?", cid)
        talkState[cid] = 1
        return true
