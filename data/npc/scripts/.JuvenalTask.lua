...
local task = {
["Juvenal"] = {{"Wardog Arcanine", 150}, {"Brave Charizard", 150}, {"Lava Magmar", 150}, {"Enraged Typhlosion", 150}},
}
        ...
        if msgcontains(msg, 'task') or msgcontains(msg, 'Task') then
           if isMyTaskComplete(cid, getNpcCid()) then
              ...
              selfSay("Then, is a simple task, i want to you kill {150 Wargod Arcanine, 150 Brave Charizard, 150 Lava Magmar and 150 Enraged Typhlosion}, you accept the task?", cid)
