...
["Tangrowth"] = {leaf, boostStone},
["Shiny Grumpig"] = {enigma, boostStone},
["Shiny Heatmor"] = {fire, boostStone},
["Pangoro"] = {punch, dark, boostStone},
["Golden Steelix"] = {metal, earth, boostStone},
["Shiny Torkoal"] = {fire, boostStone},
["Shiny Gardevoir"] = {heart, boostStone},
["Shiny Manectric"] = {thunder, boostStone},
["Infernape"] = {fire, punch, boostStone},
["Shiny Infernape"] = {fire, punch, boostStone},
["Torterra"] = {grass, earth, boostStone},
["Shiny Torterra"] = {grass, earth, boostStone},
["Honchkrow"] = {dark, feather, boostStone},
["Shiny Honchkrow"] = {dark, feather, boostStone},
["Empoleon"] = {water, steel, boostStone},
["Shiny Empoleon"] = {water, steel, boostStone},
["Luxray"] = {thunder, boostStone},
["Shiny Luxray"] = {thunder, boostStone},
["Gallade"] = {enigma, punch, boostStone},
["Shiny Gallade"] = {enigma, punch, boostStone},
["Zoroark"] = {dark, boostStone},
["Shiny Rampardos"] = {rock, boostStone},
["Carracosta"] = {rock, boostStone},
["Rhyperior"] = {rock, earth, boostStone},

["Cradily"] = {rock, leaf, boostStone},
["Togekiss"] = {enigma, feather, boostStone},
["Toxicroak"] = {venom, punch, boostStone},
["Breloom"] = {leaf, punch, boostStone},
["Froslass"] = {dark, ice, boostStone},
["Shiny Bronzong"] = {metal, enigma, boostStone},
-- new
["Shiny Sceptile"] = {leaf, boostStone},
["Shiny Heracross"] = {coccon, punch, boostStone},
["Shiny Ursaring"] = {dark, heart, boostStone},
["Shiny Dragonite"] = {crystal, boostStone},
["Shiny Flygon"] = {earth, crystal, boostStone},
["Shiny Swampert"] = {water, earth, boostStone},

["Lucario"] = {metal, punch, boostStone},
...
["Venusaur"] = {venom, leaf, boostStone},
...
["Farfetch'd"] = {feather, boostStone},
["Doduo"] = {feather, boostStone},
["Dodrio"] = {feather, boostStone},
...
["Gyarados"] = {crystal, boostStone},
["Lapras"] = {water, ice, boostStone},
["Ditto"] = {frags, boostStone},
["Shiny Ditto"] = {frags, boostStone},
...
["Aerodactyl"] = {rock, feather, boostStone},
...
["Shiny Venusaur"] = {venom, leaf, boostStone},
["Shiny Charmander"] = {fire, boostStone},
["Shiny Charmeleon"] = {fire, boostStone},
["Shiny Charizard"] = {fire, feather, boostStone},
...
["Shiny Abra"] = {enigma, dark, boostStone},
...
["Shiny Doduo"] = {feather, boostStone},
["Shiny Dodrio"] = {feather, boostStone},
...
["Shiny Gengar"] = {venom, dark, boostStone},
["Crystal Onix"] = {rock, earth, boostStone},
...
["Shiny Gyarados"] = {crystal, boostStone},
...
--
['Shiftry'] ={leaf, dark, boostStone},
['Leafeon'] = {leaf, boostStone},
['Glaceon'] = {ice, boostStone},
['Sylveon'] = {heart, boostStone},

['Treecko'] = {leaf, boostStone},
['Grovyle'] = {leaf, boostStone},
['Sceptile'] = {leaf, boostStone},

['Swellow'] = {feather, boostStone},


['Torchic'] = {fire, boostStone},
['Combusken'] = {fire, punch, boostStone},
['Blaziken'] = {fire, punch, boostStone},
['Mudkip'] = {water, boostStone},
['Marshtomp'] = {water, earth, boostStone},
['Swampert'] = {water, earth, boostStone},

['Lotad'] = {water, leaf, boostStone},
['Lombre'] = {water, leaf, boostStone},
['Ludicolo'] = {water, leaf, boostStone},
...
['Slaking'] = {ancient, boostStone},

['Nincada'] = {boostStone},
['Ninjask'] = {boostStone},
['Sheddinja'] = {boostStone},
...
['Aron'] = {metal, boostStone},
['Lairon'] = {metal, boostStone},
['Aggron'] = {metal, boostStone},

['Meditite'] = {punch, boostStone},
['Medicham'] = {punch, enigma, boostStone},
...
['Crawdaunt'] = {water, dark, boostStone},

['Baltoy'] = {earth, boostStone},
...
["Hoothoot"] = {feather, enigma, boostStone},
["Noctowl"] = {feather, enigma, boostStone},
...
["Natu"] = {enigma, feather, boostStone},
["Xatu"] = {enigma, feather, boostStone},
...
["Slowking"] = {enigma, ancient, boostStone},
...
["Gligar"] = {dark, feather, boostStone},
...
["Delibird"] = {ice, feather, boostStone},
...
["Shiny Hoothoot"] = {feather, enigma, boostStone},
["Shiny Noctowl"] = {feather, enigma, boostStone},
...
["Shiny Xatu"] = {enigma, feather, boostStone},
...
["Shiny Gligar"] = {dark, feather, boostStone},
...
["Shiny Delibird"] = {ice, feather, boostStone},
["Shiny Mantine"] = {water, boostStone},
...
if isRunning(item.itemid) and not isGod(cid) then
doPlayerSendCancel(cid, "Wait until boosting finishes.")
return true
end
-- if item.itemid == 12355 then
	-- local pb = getContainerItem(item.uid, 0).uid
	-- if pb and getItemAttribute(pb, "unique") then
		-- if getItemAttribute(pb, "unique") ~= getCreatureName(cid) and getItemAttribute(pb, "unique") ~= "npclock" then
			-- doRemoveItem(pb)
			-- doSendMsg(cid, "Unique ball deleted.")
		-- end
	-- end
-- end
