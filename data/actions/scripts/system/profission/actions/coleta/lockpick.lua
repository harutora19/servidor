...
setItemUniqueOwner(doPlayerAddItem(cid, 17102, math.random(1, 10)), cid)
...
setItemUniqueOwner(doPlayerAddItem(cid, 15996, math.random(1, 5)), cid)
setItemUniqueOwner(doPlayerAddItem(cid, 17102, math.random(1, 27)), cid)
doSendMagicEffect(getThingPos(cid), 173)
end
end, 5000)
---------- PRIMEIRA LISTA PARA SER ADICIONADA
...
local randomNormal = math.random(1,#ITENS)
for item, quantidade in pairs(ITENS[randomNormal]) do
setItemUniqueOwner(doPlayerAddItem(cid, 15996, math.random(1, 10)), cid)
setItemUniqueOwner(doPlayerAddItem(cid, 17102, math.random(1, 40)), cid)
doSendMagicEffect(getThingPos(cid), 173)
end
end, 5200)
---------- PRIMEIRA LISTA PARA SER ADICIONADA
