...
newPlayerSpawnPosX = 922
newPlayerSpawnPosY = 982
...
maxPlayers = 1000
motd = "Seja bem vindo ao Pokémon Infernal!"
displayOnOrOffAtCharlist = false
onePlayerOnlinePerAccount = true
allowClones = true
serverName = "Cronus"
loginMessage = "Seja bem vindo ao Pokémon Infernal!"
...
encryptionType = "sha1"
passwordType = encryptionType

deathListEnabled = false
deathListRequiredTime = 1 * 60 * 1000
deathAssistCount = 19
maxDeathRecords = 10
allowedMaxSizePackets = 20 -- Tente aumentar
...
timeBetweenActions = 250
timeBetweenExActions = 250
...
rateExperience = 1
premiumrateExperience = 1
ratePremiumExperience = 1
